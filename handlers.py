...
WORK_CATEGORIES = {
    "urgent": {
        ...
        "emoji": "🚨",
        "subcategories": [
            "Вскрытие / ремонт / замена замков",
            "Аварийная сантехника (течь, засор, прорвало)",
            "Аварийная электрика (пропал свет, выбивает автоматы)",
            "Срочный выезд «мастер на час»"
        ]
    },
    "handyman": {
        ...
        "emoji": "🔧",
        "subcategories": [
            "Повесить / установить (полки, карнизы, ТВ, зеркала)",
            "Мелкий ремонт дверей, ручек, петель",
            "Герметизация, силикон, швы",
            "Замена розеток, выключателей, светильников",
            "Мелкие монтажные и ремонтные работы"
        ]
    },
    "furniture": {
        ...
        "emoji": "🪑",
        "subcategories": [
            "Индивидуальный заказ кухни",
            "Индивидуальная корпусная мебель на заказ",
            "Сборка готовой мебели",
            "Сборка и установка готовых кухонь",
    ...
    "electrical": {
        ...
        "subcategories": [
            ...
            "Слаботочные системы (интернет, ТВ, домофон)"
        ]
    },
    "plumbing": {
    ...
    "heating": {
        ...
        "subcategories": [
            ...
            "Тёплые полы (электро / водяные)",
            "Обслуживание и запуск систем",
            "Котлы и обвязка"
        ]
    },
    "interior": {
    ...
    "flooring": {
        ...
        "emoji": "🪵",
        "subcategories": [
            "Ламинат, винил, линолеум, ковролин",
            "Паркет (укладка, циклёвка)",
            "Плинтуса и пороги"
        ]
    },
    "doors_windows": {
        ...
        "subcategories": [
            "Межкомнатные двери",
            "Входные двери",
            "Окна (регулировка, фурнитура)",
            "Откосы, подоконники",
            "Балконы и лоджии (утепление, обшивка)"
        ]
    },
    "hvac": {
    ...
    "demolition": {
        ...
        "emoji": "🔨",
        "subcategories": [
            "Демонтаж конструкций и отделки",
